...
- ## Cross-cutting
	...
	- [[Architecture/Bosun]] — ephemeral microVM runners for CI, and the warm pool that keeps them ready
	- [[Architecture/kthx]] — quick sites with a database, a socket and a visitor identity, at `<name>.kthx.dev`
