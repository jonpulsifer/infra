...
- ## The runbooks
	...
	- [[Runbooks/Refresh Kubernetes Admin Credentials]] — copy a cluster's renewed `cluster-admin` certificate into the kubeconfig, the one credential nothing carries for you
