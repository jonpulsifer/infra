tags:: runbook, monitoring, flameboss
...
- # If the thresholds are wrong for this cook
	- Edit `clusters/folly/monitoring/flameboss-rules.yaml` and ship it through git like any other cluster change ([[Runbooks/Kubernetes GitOps Change]]). Do not patch the live PrometheusRule: Flux owns it and will put the old numbers back.
