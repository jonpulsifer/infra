...
- ## The records
	...
	- [[ADR/0007 Offline root CA with YubiKey and SLIP-0039]] — superseded by [[ADR/0012 Migrate Vault to OpenBao]]
	- [[ADR/0012 Migrate Vault to OpenBao]] — fresh OpenBao storage; Vault data and PKI are not migrated
