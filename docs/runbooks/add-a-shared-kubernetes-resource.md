---
title: Add a shared Kubernetes resource
description: How to share a Kubernetes component between folly and offsite through clusters/base/ with Flux variable substitution.
---

Use this when adding or changing resources shared by both clusters through `clusters/base/`. General GitOps flow is in [Apply a Kubernetes change](apply-a-kubernetes-change.md).
