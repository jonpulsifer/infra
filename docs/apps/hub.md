...
The dashboard shows each station's current readings against their 24-hour low and high. With two stations, the headline shows the temperature difference between them.
