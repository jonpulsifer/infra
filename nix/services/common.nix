...
}:
{
  ...
  services.prometheus.exporters.node = {
    ...
    extraFlags = [
      "--collector.systemd.unit-include=(nfs-server|nfs-mountd|rpc-statd|dnsmasq|nginx|spore-native-boot-rackpi5|pihole-ftl|coredns|chronyd|tailscaled|ddnsd|sshd|harmonia|docker)\\.service"
    ];
  };
