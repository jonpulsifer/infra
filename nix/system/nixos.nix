...
}:
{
  ...
  # Runs pre-linked binaries such as mise tools and downloaded releases. A binary that needs more
  # than glibc gets its libraries from a per-host NIX_LD_LIBRARY_PATH.
