...
`containers.yml` builds only paths classified as container images in `.github/containers.json`. Host-native applications such as `spore` are validated and deployed through Nix instead.
