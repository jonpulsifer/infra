---
description: List available skills in this session with one-line "when to use"
---
List every skill currently available to you, in a single compact markdown table:
